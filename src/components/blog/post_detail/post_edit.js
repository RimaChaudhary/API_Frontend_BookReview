...
class PostEdit extends Component {
  ...
  handleFormSubmit({ title, categories, writer, rating, dop, content }) {

    const _id = this.props.post._id;
    categories = categories.toString();

    this.props.updatePost({ _id, title, categories, writer,rating, dop,content }, this.props.onEditSuccess, (path, state) => {
    ...
    return (
      <div className="post">
        ...
        <form onSubmit={handleSubmit(this.handleFormSubmit.bind(this))}>
          ...
          <Field name="title" component={this.renderInput} type="text" label="Writer:" placeholder="Enter name if your author" required={true} />
          <Field name="title" component={this.renderInput} type="date" label="dop:" placeholder="Enter date of publication" required={true} />
          <Field name="title" component={this.renderInput} type="number" label="Edition:" placeholder="Enter edition" required={true} />
          <Field name="title" component={this.renderInput} type="number" label="Rating:" placeholder="Enter your title" required={true} />
