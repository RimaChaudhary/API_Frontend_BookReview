...
export function createPost({ title, categories, writer, rating, edition,dop, content }, historyPush, historyReplace) {
...
export function updatePost({ _id, title, categories,writer, rating, edition,dop, content }, onEditSuccess, historyReplace) {
